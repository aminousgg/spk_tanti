    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">Pelamar</div>
                  <div class="card-body">
                    <table class="table table-bordered table-hovered tb_pelamar">
                      <thead>
                        <tr>
                          <th>ID</th>
                          <th>NIK</th>
                      ...
                      <tbody>
                        <?php foreach ($data as $row) { ?>
                          <?php
                          $_age = floor((time() - strtotime($row->tgl_lahir)) / 31556926);
                          ?>
                          <tr>
                            <td><?= $row->id_user ?></td>
                            <td><?= $row->nik ?></td>
                            <td><?= $row->nama ?></td>
                            <td><?= $row->tmp_lahir.", ".$row->tgl_lahir." (".$_age."Tahun)" ?></td>
                            <td><?= $row->no_hp ?></td>
                            <td>
                              <a href="<?= base_url('admin/pelamar/detail')."/".$row->id_user ?>" class="btn btn-primary">Detail</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
...
<script src="<?= base_url('assets_lte') ?>/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/jszip/jszip.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/pdfmake/pdfmake.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/pdfmake/vfs_fonts.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/datatables-buttons/js/buttons.print.min.js"></script>
<script src="<?= base_url('assets_lte') ?>/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
