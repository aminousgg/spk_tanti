                  ...
                  <div class="card-body">
                    <table class="table table-hovered table-bordered tb_pelamar">
                        <thead>
                            <tr>
                                <th>Nama</th>
                                <th>Pendidikan <p class="float-right text-danger m-0">(30%)</p></th>
                                <th>Sertifikasi <p class="float-right text-danger m-0">(5%)</p></th>
                                <th>Pengalaman Kerja <p class="float-right text-danger m-0">(30%)</p></th>
                                <th>Nilai Akademik <p class="float-right text-danger m-0">(30%)</p></th>
                                <th>Umur <p class="float-right text-danger m-0">(5%)</p></th>
                                <th>Result</th>
                            </tr>
                        </thead>
                        <tbody>
